...
/*Closure-------------------
- Khi một biến trong một function thì sẽ tự động được lưu lại
dù cho function đó có thực thi xong đi chăng nữa. Nên dù có gán
function này cho một biến khác thì vẫn truy cập vào được biến bên
trong function đó
* */
//Ví dụ
console.log('--------------Closure-------------');
function x() {
  ...
  // sau khi chaỵ thì call stack sẽ thực thi xong function x này
  /*Nhưng nó vẫn lưu lại biến count
   * */
}
const y = x(); //biến y giờ đây là một func nên đưa vào call stack
//sau khi function x thực thi xong từ đó truy cập được biến count
y();
y();
//Closure practice
let f;
